 ...
 */
 class BlobTeamCTF extends UTCTFGame;
...
defaultproperties
{
	...
	MapPrefixes[0]="ARECTF"
	Acronym="CTF"
	TeamAIType(0)=class'BlobTeamCTF.BlobCTFTeamAI'
	TeamAIType(1)=class'BlobTeamCTF.BlobCTFTeamAI'
	bScoreVictimsTarget=true
	DeathMessageClass=class'UTTeamDeathMessage'
	FlagKillMessageName=FLAGKILL

	OnlineGameSettingsClass=class'BlobGameSettingsCTF'
